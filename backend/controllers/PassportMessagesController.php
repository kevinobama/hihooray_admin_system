...
/**
 * PassportMessagesController implements the CRUD actions for PassportMessages model.
 */
class PassportMessagesController extends Controller
{
    ...
    /**
     * Displays a single PassportMessages model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new PassportMessages model.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return mixed
     */
    public function actionCreate()
    {
        $model = new PassportMessages();
